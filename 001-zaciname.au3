...
Po stlačením klávesy F5 sa okno zobrazí. Komentár ukončíme "mriežka ce" - comments end.
#ce

MsgBox(0, "Začíname", "Ahoj svet!")

; Viac info o MsgBoxe na adrese https://www.autoitscript.com/autoit3/docs/functions/MsgBox.htm
; Úloha: Zmeňte MsgBox tak, aby sa zobrazoval tlačidlá "Yes" a "No" a okno sa automaticky zavrelo 5 sekúnd po spustení.
